...
exports.onPostBuild = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(_ref2, pluginOptions) {
    var graphql, pathPrefix, _ref2$basePath, basePath, options, _defaultOptions$optio, query, serialize, output, exclude, hostname, resolveSiteUrl, rest, saved, excludeOptions, queryRecords, filteredRecords, urls, map, siteUrl;

    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            graphql = _ref2.graphql, pathPrefix = _ref2.pathPrefix, _ref2$basePath = _ref2.basePath, basePath = _ref2$basePath === void 0 ? pathPrefix : _ref2$basePath;
